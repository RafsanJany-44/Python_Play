...
seven = Button(btns_frame, text = "7", fg = "black", width = 10, height = 3, bd = 0, bg = "#EAFF73", cursor = "target", command = lambda: button_click(7)).grid(row = 1, column = 0, padx = 1, pady = 1)

eight = Button(btns_frame, text = "8", fg = "black", width = 10, height = 3, bd = 0, bg = "#EAFF73", cursor = "target", command = lambda: button_click(8)).grid(row = 1, column = 1, padx = 1, pady = 1)

nine = Button(btns_frame, text = "9", fg = "black", width = 10, height = 3, bd = 0, bg = "#EAFF73", cursor = "target", command = lambda: button_click(9)).grid(row = 1, column = 2, padx = 1, pady = 1)
...
four = Button(btns_frame, text = "4", fg = "black", width = 10, height = 3, bd = 0, bg = "#EAFF73", cursor = "target", command = lambda: button_click(4)).grid(row = 2, column = 0, padx = 1, pady = 1)

five = Button(btns_frame, text = "5", fg = "black", width = 10, height = 3, bd = 0, bg = "black", cursor = "target", command = lambda: button_click(5)).grid(row = 2, column = 1, padx = 1, pady = 1)
...
zero = Button(btns_frame, text = "0", fg = "black", width = 21, height = 3, bd = 0, bg = "#fff", cursor = "target", command = lambda: button_click(0)).grid(row = 4, column = 0, columnspan = 2, padx = 1, pady = 1)
